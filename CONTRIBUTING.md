...
You want to contribute to library-documentation-action-v2? Awesome.
...
First of all please [search existing issues](https://github.com/ponylang/library-documentation-action-v2/issues) to make sure your issue hasn't already been reported. If you cannot find a suitable issue — [create a new one](https://github.com/ponylang/library-documentation-action-v2/issues/new).
