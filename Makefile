...
build:
	docker build --pull --build-arg FROM_TAG="${version}-alpine" -t "${IMAGE}:${version}" .

build-latest:
	docker build --pull --build-arg FROM_TAG="alpine" -t "${IMAGE}:latest" .

build-release:
	docker build --pull --build-arg FROM_TAG="release-alpine" -t "${IMAGE}:release" .
